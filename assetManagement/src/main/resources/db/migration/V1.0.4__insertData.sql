...
insert into Employees (employee_id,dept_id,role_id,first_name,last_name,gender,email,hire_date,end_date,phone_number,user_name,dob,salary,ssn_no) values(EMP_ID_SEQ.NEXTVAL,300,200,'Ravi','Sharma','M','sharma.ravi70@gmail.com',to_date('04/12/1986', 'dd/mm/YYYY'),to_date('04/12/2100', 'dd/mm/YYYY'),3125329099,'sha123',to_date('04/12/1986', 'dd/mm/YYYY'),500000,'123-frd-34567');
insert into Employees (employee_id,dept_id,role_id,first_name,last_name,gender,email,hire_date,end_date,phone_number,user_name,dob,salary,ssn_no,reporting_manager) values(EMP_ID_SEQ.NEXTVAL,301,200,'Disha','Patel','F','disha.patel@gmail.com',to_date('04/12/1986', 'dd/mm/YYYY'),to_date('04/12/2100', 'dd/mm/YYYY'),4125328099,'pa123',to_date('04/12/1986', 'dd/mm/YYYY'),90000,'123-frd-3487',100);
